...
for (let i = 1; i <= 3; i++) {
    ...
    a.setAttribute('href', '../img/gallery/grobowce/grobowiec' + i + '.jpg')
    a.setAttribute('data-lightbox', 'grobowce')
    div.appendChild(a)

    img.setAttribute('data-src', '../img/gallery/grobowce/grobowiec' + i + '.jpg')
